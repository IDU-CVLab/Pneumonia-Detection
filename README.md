...
* The datasets used for training the CNN model to include Pnumonia cases are a combination of the COV19-CT-DB first run and the Pnomonia cases mentioned above.
